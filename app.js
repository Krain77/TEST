var qnum = 1;
			...
			const end_results = () => {
				...
				if (best == result_list.b1) itog += `Склонность к работе с людьми. Профессии, связанные с обслуживанием (бытовым,
				...
				if (best == result_list.b2) itog += `Склонность к исследовательской деятельности. Профессии, связанные с научной
				...
				if (best == result_list.b3) itog += `Склонность к исследовательской деятельности. Профессии, связанные с научной
				работой. Кроме хорошей теоретической подготовки в определенных областях науки, людям,
				занимающимся исследовательской деятельностью, необходимы такие качества, как
				рациональность, независимость и оригинальность суждений, аналитический склад `

				if (best == result_list.b4) itog += `Склонность к эстетическим видам деятельности. Профессии творческого
				...
				if (best == result_list.b5) itog += `Склонность к экстремальным видам деятельности. Профессии, связанные с
				...
				if (best == result_list.b6) itog += `Склонность к планово-экономическим видам деятельности. Профессии,
